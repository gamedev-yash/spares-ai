...
//
// A handful of rows link back to a real chat session (via `sessionId`) where
// the material genuinely matches, so "View chat" lands somewhere real —
// SPR-2847 (seal), SPR-2851 (bearing), SPR-2839 (pressure transmitter), and
// SPR-2802 (impeller). The rest are standalone SAP/Ariba pipeline records.
// ---------------------------------------------------------------------------

export const PR_PO_SITUATIONS: PrPoSituation[] = [
  {
    id: "PR-90421",
    prPoNumber: "PR-90421",
    type: "PR",
    buPlant: "Black Mountain Mine",
    materialDescription: "Seal Assy, Mech Type XR-200",
    category: "Milling",
    valueZar: 48200,
    currentStageNo: 4,
    currentStageName: "DOA (Dept. Table)",
    stuckWithPerson: "R. Patel",
    stuckWithRole: "Dept Head (L2)",
    daysStuck: 18,
    rootCauseCategory: "Scope of Work",
    urgency: "High",
    sessionId: "SPR-2847",
  },
  {
    ...
    prPoNumber: "PR-90433",
    type: "PR",
    buPlant: "Gamsberg Mine",
    materialDescription: "Slurry Pump Impeller, AH 6/4",
    category: "Flotation",
    valueZar: 74500,
    currentStageNo: 4,
    currentStageName: "DOA (Dept. Table)",
  ...
  },
  {
    ...
    prPoNumber: "PR-90452",
    type: "PR",
    buPlant: "Skorpion Zinc",
    materialDescription: "Ball Mill Trunnion Bearing",
    category: "Milling",
    valueZar: 56500,
    currentStageNo: 4,
    currentStageName: "DOA (Dept. Table)",
    stuckWithPerson: "N. Zulu",
    stuckWithRole: "Dept Head (L2)",
    daysStuck: 11,
    rootCauseCategory: "Scope of Work",
    urgency: "Normal",
  },
  {
    ...
    valueZar: 8400,
    currentStageNo: 3,
    currentStageName: "Request for Reservation (RR)",
    stuckWithPerson: "T. Mokoena",
    stuckWithRole: "Maintenance Planner",
    daysStuck: 4,
    rootCauseCategory: "Scope of Work",
    urgency: "Normal",
    sessionId: "SPR-2851",
  },
  {
    ...
    valueZar: 19800,
    currentStageNo: 1,
    currentStageName: "Maintenance Order",
    stuckWithPerson: "M. Naidoo",
    stuckWithRole: "Maintenance Planner",
    daysStuck: 1,
    rootCauseCategory: "Scope of Work",
    urgency: "Normal",
  },
  {
    ...
    type: "PR",
    buPlant: "Skorpion Zinc",
    materialDescription: "Conveyor Idler Frame",
    category: "Conveyance",
    valueZar: 12600,
    currentStageNo: 2,
    currentStageName: "Component",
    stuckWithPerson: "T. Mokoena",
    stuckWithRole: "Maintenance Planner",
    daysStuck: 2,
    rootCauseCategory: "Scope of Work",
  ...
  },
  {
    ...
    type: "PR",
    buPlant: "Skorpion Zinc",
    materialDescription: "Mill Liner Bolts Set",
    category: "Milling",
    valueZar: 28000,
    currentStageNo: 6,
    currentStageName: "Standard MRP",
    stuckWithPerson: "System",
    stuckWithRole: "SAP ECC Job",
    daysStuck: 2,
    rootCauseCategory: "System / Integration",
    urgency: "Normal",
  },
  {
    id: "PR-90454",
    ...
    type: "PR",
    buPlant: "Black Mountain Mine",
    materialDescription: "Cyclone Cluster Spigot",
    category: "Milling",
    valueZar: 9400,
    currentStageNo: 7,
    currentStageName: "PR Creation",
    stuckWithPerson: "System",
    stuckWithRole: "SAP ECC Job",
    daysStuck: 1,
    rootCauseCategory: "System / Integration",
  ...
  },
  {
    ...
    type: "PR",
    buPlant: "Gamsberg Mine",
    materialDescription: "Radar Level Transmitter",
    category: "Instrumentation",
    valueZar: 21500,
    currentStageNo: 9,
    currentStageName: "RFQ",
    stuckWithPerson: "S. van Wyk",
    stuckWithRole: "Buyer",
    daysStuck: 8,
    rootCauseCategory: "Buyer Delay",
    urgency: "Normal",
  },
  {
    id: "PO-70112",
    ...
    type: "PO",
    buPlant: "Skorpion Zinc",
    materialDescription: "Flotation Reagent Feeder",
    category: "Flotation",
    valueZar: 120000,
    currentStageNo: 9,
    currentStageName: "RFQ",
  ...
  },
  {
    ...
    type: "PO",
    buPlant: "Gamsberg Mine",
    materialDescription: "Conveyor Belt Vulcanizing Kit",
    category: "Conveyance",
    valueZar: 210000,
    currentStageNo: 10,
    currentStageName: "Ariba",
    stuckWithPerson: "A. Kumar",
    stuckWithRole: "Vendor Lead",
    daysStuck: 15,
    rootCauseCategory: "Ariba Participation",
    urgency: "High",
  },
  {
    id: "PO-70119",
    ...
    type: "PO",
    buPlant: "Black Mountain Mine",
    materialDescription: "Variable Speed Drive Unit",
    category: "Conveyance",
    valueZar: 88000,
    currentStageNo: 11,
    currentStageName: "Auction",
    stuckWithPerson: "S. van Wyk",
    stuckWithRole: "Buyer",
    daysStuck: 6,
    rootCauseCategory: "System / Integration",
  ...
  },
  {
    ...
    valueZar: 18900,
    currentStageNo: 12,
    currentStageName: "Technical Evaluation (PwC)",
    stuckWithPerson: "PwC Team",
    stuckWithRole: "External Evaluator",
    daysStuck: 22,
    rootCauseCategory: "Technical Evaluation (PwC)",
    urgency: "Critical",
    sessionId: "SPR-2839",
  },
  {
    ...
    type: "PR",
    buPlant: "Gamsberg Mine",
    materialDescription: "Vibration Sensor, Mill Girth Gear",
    category: "Instrumentation",
    valueZar: 15200,
    currentStageNo: 12,
    currentStageName: "Technical Evaluation (PwC)",
  ...
  },
  {
    ...
    valueZar: 42500,
    currentStageNo: 13,
    currentStageName: "NFA",
    stuckWithPerson: "P. Govender",
    stuckWithRole: "Finance Head",
    daysStuck: 12,
    rootCauseCategory: "NFA Approval",
    urgency: "Critical",
  },
  {
    id: "PR-90445",
    ...
    type: "PR",
    buPlant: "Gamsberg Mine",
    materialDescription: "Slurry Pipe Flange",
    category: "Flotation",
    valueZar: 45000,
    currentStageNo: 14,
    currentStageName: "Ariba Manual",
    stuckWithPerson: "K. Dlamini",
    stuckWithRole: "Senior Buyer",
    daysStuck: 9,
    rootCauseCategory: "Vendor Payment",
    urgency: "High",
  },
]

export function getStagePipeline(): StagePipelinePoint[] {
  return PROCESS_STAGES.map((stage) => {
    const items = PR_PO_SITUATIONS.filter((i) => i.currentStageNo === stage.no)
    return {
      stageNo: stage.no,
      stageName: stage.name,
      count: items.length,
      valueZar: items.reduce((sum, i) => sum + i.valueZar, 0),
      maxDaysStuck: items.reduce((max, i) => Math.max(max, i.daysStuck), 0),
      totalDaysStuck: items.reduce((sum, i) => sum + i.daysStuck, 0),
    }
  })
}

export function getRootCauseBreakdown(): RootCauseDelayPoint[] {
  return ROOT_CAUSE_CATEGORIES.map((category) => {
    const items = PR_PO_SITUATIONS.filter((i) => i.rootCauseCategory === category)
    return {
      category,
      totalDaysLost: items.reduce((sum, i) => sum + i.daysStuck, 0),
      itemCount: items.length,
    }
  }).sort((a, b) => b.totalDaysLost - a.totalDaysLost)
}

export function getSituationAnalysisSummary(): SituationAnalysisSummary {
  const totalCount = PR_PO_SITUATIONS.length
  const totalValueZar = PR_PO_SITUATIONS.reduce((sum, i) => sum + i.valueZar, 0)
  const avgDaysStuck =
    PR_PO_SITUATIONS.reduce((sum, i) => sum + i.daysStuck, 0) / totalCount
  const highRiskCount = PR_PO_SITUATIONS.filter((i) => i.daysStuck > 10).length

  const pipeline = getStagePipeline()
  const topStage = pipeline.reduce((top, stage) =>
    stage.totalDaysStuck > top.totalDaysStuck ? stage : top
  )
  ...
  return {
    ...
    avgDaysStuck,
    highRiskCount,
    topBottleneckStage: { no: topStage.stageNo, name: topStage.stageName },
  }
}
